// Jigsaw typography: the word PRATEEK cut into distorted tiles that reshuffle
// every couple of seconds. Renders into a <canvas id="typeCanvas">, sized to
// its parent. Returns a cleanup function.
...
export function initJigsawTypography() {
