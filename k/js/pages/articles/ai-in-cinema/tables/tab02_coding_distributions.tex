\begin{table}[htbp]
\centering
\caption{Distribution of the AI codings in the core population and in the two robustness subsets.}
\label{tab:coding_distributions}
\begin{tabular}{lrrr}
\toprule
Coding & All core films (n = 2,015) & $\geq$ 100 TMDB votes (n = 265) & High-confidence codings (n = 496) \\
\midrule
*Frame* &  &  &  \\
