\begin{table}[htbp]
\centering
\caption{Tests of the five claims in each population. Brackets are 95\% confidence intervals; OR = odds ratio from a logistic regression on release year.}
...
$\geq$ 100 TMDB votes & 1. Two dominant frames & Bimodality coefficient ($>$ 0.555 = two modes) & 0.47 [0.42, 0.52] & — & Not supported \\
